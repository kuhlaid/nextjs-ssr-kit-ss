...
const LoadingTagsComponent = ({ className }: LoadingTagsProps) => (
  <FadeIn data-testid="loading-tags" timing="0.6s">
    <div data-testid="loading-tag-card" className={className} />
  </FadeIn>
);
const LoadingTags = styled(LoadingTagsComponent)`
  @keyframes wave {
    0% {
      left: -60%;
    }
